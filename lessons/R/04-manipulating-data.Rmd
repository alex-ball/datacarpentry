...
<!-- The following block should be highlighted:
surveys_DO is used in the challenge below. -->
```{r, purl=FALSE}
...
<!-- The following blocks should be highlighted:
species is used below. -->
```{r, echo=FALSE, purl=FALSE}
...
<!-- The following block should be highlighted:
surveys_spid_index and surveys_genera are used below. -->
```{r, purl=TRUE}
...
<!-- The following block should be highlighted:
surveys_DO and surveys_DM are used below. -->
```{r, purl=FALSE}
surveys_DO <- subset(surveys, species == "DO")
